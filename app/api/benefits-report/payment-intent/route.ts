...
export async function POST(req: Request) {
  ...
  try {
    ...
    const intent = await stripe.paymentIntents.create({
      ...
      metadata: { product: BENEFITS_REPORT_PRODUCT, buyer_name: firstName, buyer_state: state, buyer_zip: zip, intake_token: intakeToken, source_payment_intent: sourcePaymentIntentId, credit: String(credit), list_price: String(BENEFITS_REPORT_PRICE), tax_calculation: taxCalculation },
