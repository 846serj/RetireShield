      ...
      <div className="rg-page-shell">
        <div className="mx-auto flex min-h-[calc(100vh-5rem)] max-w-3xl items-center px-4 py-6 sm:py-10 lg:max-w-5xl">
          <section className="w-full overflow-hidden rounded-[2rem] bg-brand-dark px-5 py-8 text-center text-white shadow-2xl shadow-brand-dark/20 sm:px-10 sm:py-12">
            ...
            <p className="mx-auto mt-6 flex max-w-xl items-center justify-center gap-2 text-center text-lg font-semibold leading-8 text-white/90 sm:text-xl lg:max-w-2xl"><svg viewBox="0 0 24 24" fill="none" className="size-5 shrink-0" aria-hidden="true"><circle cx="12" cy="12" r="9" stroke="#7BD3A8" strokeWidth="2" /><path d="M8.5 12.5l2.5 2.5 4.5-5.5" stroke="#7BD3A8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" /></svg><span>Real numbers, no sales pitch — just a clear picture of where you stand.</span></p>
