...
export default function BenefitsChecklistPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <div className="bg-white pb-24 text-ink sm:pb-0">
      ...
      <BenefitsChecklistCheckout attribution={attribution} statePacksReady={statePacksReady} stripePublishableKey={stripePublishableKey} paypalClientId={paypalClientId} />
