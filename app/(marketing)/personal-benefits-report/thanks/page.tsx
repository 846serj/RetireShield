...
export default async function BenefitsReportThanks({ searchParams }: { searchParams: SearchParams }) {
  ...
  let valid = false;
  let paidIntent: Awaited<ReturnType<typeof stripe.paymentIntents.retrieve>> | null = null;
