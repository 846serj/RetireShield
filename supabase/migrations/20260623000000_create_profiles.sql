create table if not exists profiles (
  ...
  state text,
  balance_taxable numeric(14,2),
  taxable_cost_basis numeric(14,2),
  balance_tax_deferred numeric(14,2),
  balance_roth numeric(14,2),
  stock_pct numeric(5,2),
  ...
  spending_essential_monthly numeric(14,2),
  spending_discretionary_monthly numeric(14,2),
