...
const LEADGEN_ALLOWLIST_EXACT_PATHS = new Set(["/quiz", "/newsletter", "/privacy", "/terms", "/refund-policy"]);
const LEADGEN_ALLOWLIST_PREFIXES = ["/api/lead", "/api/newsletter", "/auth", "/_next", "/favicon", "/robots", "/sitemap", "/manifest", "/s"];
